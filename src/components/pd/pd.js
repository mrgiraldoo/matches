...
export default class PdMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/PD/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
