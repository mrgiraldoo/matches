...
export default class BsaMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/BSA/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
