...
export default class ElcMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/ELC/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
