...
export default class PplMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/PPL/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
