...
export default class ClMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/CL/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
