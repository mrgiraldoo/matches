...
export default class SaMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/SA/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
