...
export default class EcMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/EC/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
