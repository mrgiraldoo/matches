...
export default class DedMatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/DED/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
