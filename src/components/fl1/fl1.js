...
export default class Fl1MatchList extends React.Component {
  state = {
    matches: []
  }
  ...
  componentDidMount() {
    ...
    axios.get('https://api.football-data.org/v2/competitions/FL1/matches?dateFrom='+fromDate+'&dateTo='+toDate, {headers})
      .then(res => {
